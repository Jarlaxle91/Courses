...
public class AddressBookEntry {
  ...
  public void setUp() throws Exception {
    System.setProperty("webwd.chrome.wd", "c:/windows/system32/chromewd.exe");
    wd = new ChromeDriver();
  ...
  public void testAddressBookEntry() throws Exception {
    ...
    fillEntryForm(new ContactData("Test first name", "Test middle name",
            ...
            "1", "January", "1990", "2",
            "February", "2001", "test1"));
    extractContactCreation();
    gotoHomePage();
    logout();
  }

  private void extractContactCreation() {
  ...
  private void fillEntryForm(ContactData contactData) {
